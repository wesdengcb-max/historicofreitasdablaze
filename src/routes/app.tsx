      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-none">
          {section === "sinais" ? (
            ...
            <main className="mx-auto flex w-full max-w-none flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8 lg:py-8">
          ...
          >
            ...
            {viewMode === "colunas" && contarColunas && (
              <div className="mb-3 w-full border-b border-white/5 pb-3 overflow-x-auto scrollbar-none">
                <div className="grid grid-cols-[repeat(10,max-content)] gap-x-[12px] gap-y-0 w-max">
              ...
              >
                ...
                {loading ? (
                  ...
                  <div className="history-scroll w-full overflow-x-auto p-1 sm:p-2 lg:p-3 no-scrollbar">
                    <div className="flex w-max min-w-full flex-col gap-0">
                      {/* Cabeçalho 0-9 interno para Colunas Fixas */}
                      <div className="grid grid-cols-[repeat(10,max-content)] gap-x-[12px] gap-y-0 mb-2 sticky top-0 z-10 bg-[#090B0D]/90 backdrop-blur-sm w-full">
                        {Array.from({ length: 10 }).map((_, ci) => (
                          <button
                            key={`header-inner-${ci}`}
                      ...
                      {gridRows.map((row) => (
                        <div key={row.key} className="flex flex-col gap-0 border-none py-1">
                          <div className="grid grid-cols-[repeat(10,max-content)] gap-x-[12px] gap-y-0 relative w-max border-none">
