  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onClick}
        className="group flex w-full cursor-pointer items-center justify-center overflow-hidden transition-[transform,opacity,box-shadow,border-color] duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_12px_rgba(255,255,255,0.1)] active:scale-95"
        style={{
          height: `var(--blaze-card-h, ${BLAZE_CARD_TOP_H}px)`,
          borderRadius: 8,
          border: selected ? `2px solid var(--primary)` : `1px solid ${c.border}`,
          background: c.bg,
        ...
        {isWhite && !numbered ? (
          ...
          <span
            ...
            style={{
              ...
              width: "30px",
              fontSize: "14px",
              border: `2px solid ${isWhite ? c.ring : "#ffffff95"}`,
              color: c.fg,
            }}
          >
            {n}
